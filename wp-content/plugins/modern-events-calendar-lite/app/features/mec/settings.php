                ...
                <ul id="" class="subsection" style="display: block;">
                    ...
                    <li id="" class="pr-be-group-menu-li">
                        <a href="#event_options" id="" class="wns-be-group-tab-link-a">
                            <span class="pr-be-group-menu-title"><?php _e('Checkpoint Details/Single Event Page', 'modern-events-calendar-lite'); ?></span>
                        </a>
                    </li>                                                           
            ...
            <div class="mec-container">
                ...
                <form id="mec_settings_form">
                        ...
                        <div class="mec-form-row">
                            ...
                            <div class="mec-col-4">
                                <select id="mec_settings_category_events_method" name="mec[settings][category_events_method]">
                                    <option value="1" <?php if(!isset($settings['category_events_method']) or (isset($settings['category_events_method']) and $settings['category_events_method'] == 1)) echo 'selected="selected"'; ?>><?php _e('Upcoming Checkpoints', 'modern-events-calendar-lite'); ?></option>
                                ...
                                <a class="mec-tooltip" title="<?php esc_attr_e("Default value is Upcoming Checkpoints", 'modern-events-calendar-lite'); ?>"><i title="" class="dashicons-before dashicons-editor-help"></i></a>
                            </div>
                        </div>
                    ...
                    <div id="event_options" class="mec-options-fields">
                        ...
                        <h4 class="mec-form-subtitle"><?php _e('Checkpoint Details/Single Event Page', 'modern-events-calendar-lite'); ?></h4>
                        <div class="mec-form-row">
