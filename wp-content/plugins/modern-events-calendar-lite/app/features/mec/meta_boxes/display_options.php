            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_countdown_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4" name="mec[sk-options][countdown][event_id]" id="mec_skin_countdown_event_id">
                        <option value="-1" <?php if(isset($sk_options_countdown['event_id']) and $sk_options_countdown['event_id'] == '-1') echo 'selected="selected"'; ?>><?php echo __(' -- Next Upcoming Checkpoint -- ', 'modern-events-calendar-lite') ?></option>
                        <?php foreach($events as $event): ?>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_available_spot_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4" name="mec[sk-options][available_spot][event_id]" id="mec_skin_available_spot_event_id">
                        <option value="-1" <?php if(isset($sk_options_available_spot['event_id']) and $sk_options_available_spot['event_id'] == '-1') echo 'selected="selected"'; ?>><?php echo __(' -- Next Upcoming Checkpoint -- ', 'modern-events-calendar-lite') ?></option>
                        <?php foreach($events as $event): ?>
