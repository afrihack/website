...
class MEC_feature_contextual extends MEC_base
{
    ...
    public function settings()
    {
        ...
        <div class="mec-form-row" id="mec_setting_contextual">
            ...
            <ul class="mec-accordion mec-message-categories" id="mec_message_categories_wp">
                <li class="mec-acc-label" data-key="event_detail" data-status="close"><?php _e('Checkpoint Details/Single Event Page','modern-events-calendar-lite'); ?></li>
                <ul id="mec-acc-event_detail" style="display: none;">
                <h2 class="dark-text">Checkpoint Details/Single Event Page<hr></h2>
                <ol class="list-w">
